    ...
    return (
        <div className="space-y-6 animate-fade-in relative pb-12">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 data-tour="system-header" className="text-2xl font-black text-slate-900 dark:text-white tracking-tight uppercase">System Health</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div data-tour="supabase-status-card" className="bg-white dark:bg-[#1a1c23] rounded-2xl border border-slate-100 dark:border-slate-800/50 shadow-sm p-6">
                ...
                <div data-tour="security-api-card" className="bg-white dark:bg-[#1a1c23] rounded-2xl border border-slate-100 dark:border-slate-800/50 shadow-sm p-6">
                    <div className="flex items-center gap-3 mb-6">
            ...
            <div data-tour="system-logs-card" className="bg-slate-900 dark:bg-black rounded-2xl p-6 shadow-xl border border-slate-800 font-mono text-sm overflow-hidden relative border-t-4 border-t-indigo-500/30">
